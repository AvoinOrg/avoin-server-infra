...
- `secondary/pelias/` — Pelias geocoding stack: API + Elasticsearch + libpostal with profiled OpenStreetMap config/download/import jobs, an OSM dataset/import plan, and a documented Finnish official-data/Pelias CSV extension point. Only the API is exposed via Traefik labels on `proxy-net`.
